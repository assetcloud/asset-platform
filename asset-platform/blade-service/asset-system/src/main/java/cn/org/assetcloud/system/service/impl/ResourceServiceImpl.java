...
import cn.org.assetcloud.system.mapper.ResourceMapper;
...
import cn.org.assetcloud.system.utils.ResourceNodeMerger;
...
public class ResourceServiceImpl extends ServiceImpl<ResourceMapper, Resource> implements IResourceService {
    ...
    public boolean addFuncResource(Resource formResource) throws CloneNotSupportedException {
        ...
        SceneRole one = sceneRoleService.getOne(Wrappers.<SceneRole>lambdaQuery()
                ...
                .eq(SceneRole::getRoleType, SystemConstant.ADMIN_ROLE_ID));
