...
public class FormInstController {
    ...
    public RespBean listFormInst(    @RequestParam(value = "user_id") String userID,
                                 ...
                                 @ApiParam(value = "当前用户在当前工作场景下所属的部门Id，这个信息需要向组织架构请求获取")
    ...
    public RespBean formInstsCount(@RequestParam(value = "user_id") String userID,
                                   @ApiParam(value = "当前用户在当前工作场景下所属的部门Id，这个信息需要向组织架构请求获取",
                                           required = true) @RequestParam(value = "scene_id") String sceneId,
                                   @RequestParam(value = "section_id") String sectionId){
...
//                                     @RequestParam(value = "scene_id") String sceneId,   //这里点击外链，不需要对工作场景进行筛选
                                     @ApiParam(value = "当前用户在当前工作场景下所属的部门Id，这个信息需要向组织架构请求获取",
                                             required = true) @RequestParam(value = "section_id") String sectionId){
