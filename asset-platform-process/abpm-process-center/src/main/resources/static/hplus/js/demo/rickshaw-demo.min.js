$(function () {
    var e = new Rickshaw.Graph({
        ...
        series: [{color: "#4787F7", data: [{x: 0, y: 40}, {x: 1, y: 49}, {x: 2, y: 38}, {x: 3, y: 30}, {x: 4, y: 32}]}]
    });
    e.render();
    ...
    var a = new Rickshaw.Graph({
        ...
        renderer: "line",
        series: [{data: [{x: 0, y: 40}, {x: 1, y: 49}, {x: 2, y: 38}, {x: 3, y: 30}, {x: 4, y: 32}], color: "#4787F7"}]
    });
    a.render();
    ...
    var c = new Rickshaw.Graph({
        ...
        series: [{
            data: [{x: 0, y: 15}, {x: 1, y: 18}, {x: 2, y: 10}, {x: 3, y: 12}, {x: 4, y: 15}, {
                x: 5,
                y: 24
            }, {x: 6, y: 28}, {x: 7, y: 31}, {x: 8, y: 22}, {x: 9, y: 18}, {x: 10, y: 16}], color: "#4787F7"
        }]
    });
    c.render()
});
