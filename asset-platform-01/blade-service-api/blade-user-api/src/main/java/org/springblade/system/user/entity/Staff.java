...
public class Staff implements Serializable {
    ...
    public void setAuthorizedStrength(String authorizedStrength) {
        this.authorizedStrength = authorizedStrength == null ? null : authorizedStrength.trim();
    }
    ...
    public void setPartyGroup(String partyGroup) {
        this.partyGroup = partyGroup == null ? null : partyGroup.trim();
    }
    ...
    public String getUserCreatedTag() {
        return userCreatedTag;
    }

    public void setUserCreatedTag(String userCreatedTag) {
        this.userCreatedTag = userCreatedTag == null ? null : userCreatedTag.trim();
    }
    ...
    public void setStaffReligion(String staffReligion) {
        this.staffReligion = staffReligion == null ? null : staffReligion.trim();
    }
    ...
    public void setAcademicCredential(String academicCredential) {
        this.academicCredential = academicCredential == null ? null : academicCredential.trim();
    }
    ...
    public String toString() {
        return "Staff{" +
                ...
                ", overseasRelation='" + overseasRelation + '\'' +
