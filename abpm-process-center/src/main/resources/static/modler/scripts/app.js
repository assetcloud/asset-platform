...
flowableModeler
  ...
  .config(['$provide', '$routeProvider', '$selectProvider', '$translateProvider', function ($provide, $routeProvider, $selectProvider, $translateProvider) {
    ...
    $routeProvider
        ...
        //点击peocesses.html中的流程框中任一位置，显示正常的流程详情页面
        .when('/processes/:modelId', {
            templateUrl: appResourceRoot + 'views/process.html',
            controller: 'ProcessCtrl'
        })
        //点击peocesses.html中的放大镜按钮之后，被processes.js中的相关方法所响应，接着重新指向这个路径，被该路由捕获，显示流程迁移页面
        .when('/changeprocesses/:modelId', {
        templateUrl: appResourceRoot + 'views/change-process.html',
        controller: 'ChangeProcessCtrl'
        })
