...
public interface SystemConstant {
    ...
    Resource RESOURCE_FORM_PRINT = new Resource(CODE_FUNC, NAME_FORM_PRINT, ICON_FORM_PRINT, FORM_PRINT ,2 , SORT_FORM_PRINT, 3);
    Resource RESOURCE_FORM_DELETE = new Resource(CODE_FUNC, NAME_FORM_DELETE, ICON_FORM_DELETE, FORM_DELETE ,2 , SORT_FORM_DELETE, 3);
